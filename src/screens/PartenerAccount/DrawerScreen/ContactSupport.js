...
const ContactSupport = ({navigation,info}) => {
 ...
 async function contactGym(){
    ...
    axios.post("https://imtekh.com/noman/zurovas_backend/api/contact-support",
    formData, {
      headers: {
  ...
  return (
   ...
   <Text>Your Message</Text>
    ...
    />
       ...
       <Button  onPress={() => contactGym()}  buttonStyle={{marginTop:30,borderRadius:10}} title="Send to Admin" />
