...
class GymStats extends React.PureComponent {
    constructor(props) {
        super(props);
      this.state = {
    ...
    getUserStats= async()=>{
        axios.get("https://imtekh.com/noman/zurovas_backend/api/gyms-activities",
        {
          headers: {
    ...
    render() {
        ...
        return (
            <View style={{flex:1,paddingTop:'10%',marginLeft:10}}>
                <Text style={{fontSize:20}}>Gym Stats</Text>
            ...
            <Text>{ this.state.userStats?.total_gyms+"  Total Registered Gyms"}</Text>
            <View style={{flexDirection:'row',alignItems:'center',flex:1}}>
            <View style={{width:'10%',height:'11%',borderRadius:15,backgroundColor:'rgb(128,128,128)'}}/>
            <Text style={{marginLeft:5}}>New Gyms</Text>
            </View>
            <View style={{flexDirection:'row',alignItems:'center',flex:1}}>
            <View style={{width:'10%',height:'11%',borderRadius:15,backgroundColor:'rgb(128,128,128)'}}/>
            <Text style={{marginLeft:5}}>Inactive Gyms</Text>
            </View>
