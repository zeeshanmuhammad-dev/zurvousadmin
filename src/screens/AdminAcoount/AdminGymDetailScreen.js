...
const AdminGymDetail = (props) => {
  ...
  const [gymDet, setGymDetail] = useState('');
  ...
  useEffect(() => {
    setisVisible(true)
    getGymDetail(props.route.params.id)
  },[])

  function getGymDetail(id){
    getRequest(ApiRoute.gymDetail+id).then(res => {
      ...
      <View style={Styles.contentView}>
        ...
        <View style={Styles.contentMainView}>
          ...
          <View style={Styles.contentMainViewTextView}>
            <Text style={Styles.nameText}>{gymDet.full_name}</Text>
            <Text style={Styles.costText}>{gymDet.email}</Text>
          </View>
        </View>
        ...
        <View style={[Styles.listItemLocationTextView,{flexDirection: 'row'}]}>
                        <View style={[Styles.listItemLocationTextViewInner,{flexDirection: 'row'}]}>
                            <Icon
                                ...
                                style={Styles.icon}
                            />
                            <Text style={Styles.listItemText2}>{gymDet.full_name1}</Text>
                        </View>
                        <Text>{'    '}</Text>
                        <View style={[Styles.listItemLocationTextViewInner,{flexDirection: 'row'}]}>
                            <Icon
                                ...
                                style={Styles.icon}
                            />
                            <Text style={Styles.listItemText2}>{gymDet.street_address}</Text>
                        </View>
        ...
        <View style={Styles.contentViewList}>
          <View style={Styles.listItem}>
            <Text style={Styles.textStyle1}>Cost</Text>
            <Text style={Styles.textStyle1}>{gymDet.cost_per_day} USD/day</Text>
          </View>
          <View style={Styles.spacer} />
          <View style={Styles.listItem}>
            <Text style={Styles.textStyle1}>Contact</Text>
        <Text style={Styles.textStyle1}>{gymDet.phoneno}</Text>
          </View>
        </View>
        ...
        <Text style={Styles.textStyle2}>{gymDet.status}</Text>
        </View>
      </View>
