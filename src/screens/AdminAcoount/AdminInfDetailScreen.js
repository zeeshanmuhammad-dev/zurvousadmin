...
const AdminInfDetailScreen = (props) => {


  const [infDet, setUserDetail] = useState('');
  ...
  useEffect(() => {
    setisVisible(true)
    getiInfDet(props.route.params.id)
  },[])

  function getiInfDet(id){
    getRequest(ApiRoute.infDetail+id).then(res => {
      ...
      <View style={Styles.contentView}>
        ...
        <View style={Styles.contentMainView}>
          ...
          <View style={Styles.contentMainViewTextView}>
            <Text style={Styles.nameText}>{infDet.name}</Text>
            <Text style={Styles.costText}>{infDet.email}</Text>
          </View>
        </View>
        ...
        <View style={Styles.contentViewList}>
          <View style={Styles.listItem}>
            ...
            <Text style={Styles.textStyle1}>{infDet.datetime}</Text>
          </View>
...
export default AdminInfDetailScreen;
