...
import {View,StyleSheet,FlatList,ScrollView,Image,LogBox} from 'react-native';
...
const AdminTransactionCredited = (props) => {
...
const getData=async()=>{
  ...
  console.log(props?.info?.id ,'user get credits')
      axios.get("https://imtekh.com/noman/zurovas_backend/api/all_transactions/"+props?.info?.id,
        {
          params: {
          },
...
export default connect(mapStateToProps)(AdminTransactionCredited);
